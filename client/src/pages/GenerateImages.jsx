...
const GenerateImages = () => {
  ...
  const imageStyle = [
    'Realistic', 'Ghibli style', 'Anime style', 'Cartoon style', 'Fanstasy style', 'Realistic style', '3D style', 'Potrait style'
  ]
  ...
  return (
    <div className='h-full overflow-y-scroll p-8 flex items-start flex-wrap gap-8 text-slate-700'>
      {/* Left col */}
      ...
      {/* Right col */}
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-118'>
        <div className='flex items-center gap-3'>
